...
function App() {
  ...
  useEffect(() => {
    const hasSeenTutorial = localStorage.getItem("cc-switch-tutorial-seen");
    if (!hasSeenTutorial && Object.keys(providers).length === 0) {
  ...
  const handleTutorialComplete = () => {
    localStorage.setItem("cc-switch-tutorial-seen", "true");
